...
/**
 * SS Entry Importer config.php
 *
 * This file exists only as a template for the SS Entry Importer settings.
 * It does nothing on its own.
 *
 * Don't edit this file, instead copy it to 'craft/config' as 'ss-entry-importer.php'
